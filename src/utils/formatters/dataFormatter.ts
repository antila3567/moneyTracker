...
export const monthA = [
  { title: 'all', number: 0, sym: '🌎' },
  { title: '1', number: 1, sym: '❄️' },
  { title: '2', number: 2, sym: '☃️' },
  { title: '3', number: 3, sym: '🥀' },
  { title: '4', number: 4, sym: '🌳' },
  { title: '5', number: 5, sym: '🍀' },
  { title: '6', number: 6, sym: '🌡️' },
  { title: '7', number: 7, sym: '🥵' },
  { title: '8', number: 8, sym: '🔥' },
  { title: '9', number: 9, sym: '🌧️' },
  { title: '10', number: 10, sym: '🍂' },
  { title: '11', number: 11, sym: '💨' },
  { title: '12', number: 12, sym: '🥶' },
];
