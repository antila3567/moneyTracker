    ...
    return (
        <SafeAreaView style={styles.wrapper}>
            <View style={styles.headerBlock}>
                <Image style={styles.logoImg} source={switchColor
                    ? require('../../assets/image/logotypes/logoText.png')
                    : require('../../assets/image/logotypes/logoWhiteText.png')
                } />
            </View>
            <View>
                <Image style={styles.onboardImg} source={require('../../assets/image/onboarding/onboarding.png')} />
            </View>
            <View style={styles.description}>
                <Text style={styles.descrTitleText}>
                    {I18n.t('onboardTitle')}
                </Text>
